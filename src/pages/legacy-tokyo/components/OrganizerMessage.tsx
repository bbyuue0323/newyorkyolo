...
function AnimatedBlock({ children, delay = 0, direction = 'up' }: { children: React.ReactNode; delay?: number; direction?: 'up' | 'down' | 'left' | 'right' | 'none' }) {
  ...
  return (
    <section id="organizer-message" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <AnimatedBlock delay={200} direction="up">
