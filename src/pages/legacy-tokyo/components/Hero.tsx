  ...
  return (
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center text-white px-6">
        <h1 className="text-6xl md:text-7xl font-light tracking-wider mb-6" style={{ fontFamily: "'Playfair Display', serif" }}>
          LEGACY TOKYO
        </h1>
        <div className="w-24 h-px bg-[#B11226] mx-auto mb-6"></div>
        <p className="text-lg md:text-xl font-light tracking-wide mb-12" style={{ fontFamily: "'Playfair Display', serif" }}>
          東京から新しい財産となる出会いを
        </p>
