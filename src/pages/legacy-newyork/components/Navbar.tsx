      ...
      >
        <div className="px-8 pt-20 pb-8 space-y-1 overflow-y-auto h-full">
          ...
          <div className="py-2">
            ...
            <div className="space-y-2 pl-5 border-l-2 border-[#B11226]">
              <button onClick={() => scrollToSection('attractive')} className="block text-[#B11226] font-medium text-sm cursor-pointer whitespace-nowrap">Legacy NewYork</button>
              <Link to="/legacy-tokyo" onClick={() => setIsMenuOpen(false)} className="block text-white/60 hover:text-[#B11226] transition-colors text-sm cursor-pointer whitespace-nowrap">Legacy Tokyo</Link>
            </div>
          </div>
