        ...
        <ScrollReveal>
          <div className="mb-16">
            <div className="flex items-start gap-8 mb-8">
              <p className="text-6xl font-light text-gray-100" style={{ fontFamily: "'Playfair Display', serif" }}>03</p>
              <div>
                <h3 className="text-xs tracking-widest text-gray-400 mb-3">SOCIAL MEDIA</h3>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-px bg-[#B11226]"></div>
                  <h2 className="text-2xl font-light text-[#111111]" style={{ fontFamily: "'Playfair Display', serif" }}>SNS</h2>
                </div>
              </div>
            </div>
          </div>
            ...
            <ScrollReveal key={index} delay={index * 120} direction="up">
              ...
              >
                {sns.instagramHover ? (
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${sns.color} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}></div>
                )}
                <div className="relative p-8 text-center">
                  <div className="w-16 h-16 mx-auto mb-4 flex items-center justify-center rounded-full bg-gray-200 group-hover:bg-white/20 transition-colors">
                    <i className={`${sns.icon} text-3xl text-[#111111] group-hover:text-white transition-colors`}></i>
                  </div>
                  <h3 className="text-xl font-medium mb-2 text-[#111111] group-hover:text-white transition-colors" style={{ fontFamily: "'Playfair Display', serif" }}>{sns.name}</h3>
                  <p className="text-lg font-semibold text-[#B11226] group-hover:text-white transition-colors mb-1">{sns.followers}</p>
                  <p className="text-xs text-gray-400 group-hover:text-white/70 transition-colors">followers</p>
                </div>
              </a>
            </ScrollReveal>
          ))}
